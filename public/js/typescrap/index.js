    ...
    $('#dynamic-table').DataTable( {
        ...
        "aoColumns": [
            ...
            { data: null,
                ...
                {
                    var text = '';
                    if ( $.inArray('update_typeScrap', $permissions) !== -1 ) {
                        text = text + '<a href="'+document.location.origin+ '/dashboard/editar/retaceria/'+item.id+
                            '" class="btn btn-outline-warning btn-sm"><i class="fa fa-pen"></i></a>';
                    }
                    if ( $.inArray('destroy_typeScrap', $permissions) !== -1 ) {
        ...
        $.confirm({
            ...
            buttons: {
                confirmar: {
                    ...
                    action: function () {
                        $.ajax({
                            url: '/dashboard/typescrap/delete-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
...
function openModalDelete() {
    var typeScrap_id = $(this).data('delete');
    var name = $(this).data('name');

    $modalDelete.find('[id=typeScrap_id]').val(typeScrap_id);
