                        ...
                        if (!item.finance) {
                            ...
                            if ( item.type_order == 'purchase' )
                            {
                                if ( $.inArray('regularizeOrder_entryPurchase', $permissions) !== -1 ) {
                                    if (item.purchase_order == '' || item.purchase_order == null)
                                    {
                                        text = text + ' <a href="'+document.location.origin+ '/dashboard/regularizar/automaticamente/entrada/compra/finanzas/'+item.id+'" '+
                                            ' class="btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="top" title="Regularizar automaticamente compra finanza"><i class="fas fa-share-square"></i></a>';
                                    }
                                }
                            } else {
                                if ( $.inArray('regularizeOrder_entryPurchase', $permissions) !== -1 ) {
