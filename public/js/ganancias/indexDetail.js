...
$(document).ready(function () {
    ...
    $ganancia = JSON.parse($('#ganancia').val());
    getDataGanancias(1);
...
function getDataGanancias($numberPage) {
    ...
    $.get('/dashboard/get/data/ganancia/details/V2/'+$numberPage, {
...
function renderDataGananciasEmpty(data) {
    ...
    $("#pagination").html('');
    $("#textPagination").html('');
    $("#textPagination").html('Mostrando '+pagination.startRecord+' a '+pagination.endRecord+' de '+pagination.totalFilteredRecords+' detalles');
    $('#numberItems').html('');
...
function renderDataTable(data) {
    ...
    clone.querySelector("[data-date_detail]").innerHTML = data.date_detail;
    clone.querySelector("[data-material_description]").innerHTML = data.material_description;
    clone.querySelector("[data-quantity]").innerHTML = data.quantity;
    clone.querySelector("[data-price_sale]").innerHTML = data.price_sale;
    clone.querySelector("[data-utility]").innerHTML = data.utility;
