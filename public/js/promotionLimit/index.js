...
function getDataPromotions($numberPage) {
    ...
    $.get('/dashboard/get/data/promotion/limits/'+$numberPage, function(data) {
...
function renderDataTable(data) {
    ...
    clone.querySelector("[data-limit_quantity]").innerHTML = data.limit_quantity;
    clone.querySelector("[data-applies_to]").innerHTML = data.applies_to;
    clone.querySelector("[data-original_price]").innerHTML = data.original_price;
    clone.querySelector("[data-promo_price]").innerHTML = data.promo_price;
    ...
    if ( $.inArray('edit_promotionLimit', $permissions) !== -1 ) {
        let url = document.location.origin+ '/dashboard/editar/promocion/limite/'+data.id;
        cloneBtnCreated.querySelector("[data-editar_promotion]").setAttribute("href", url);
    } else {
        let element = cloneBtnCreated.querySelector("[data-editar_promotion]");
        if (element) {
            element.style.display = 'none';
        }
    }

    if ( $.inArray('destroy_promotionLimit', $permissions) !== -1 ) {
