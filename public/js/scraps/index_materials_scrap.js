...
$(document).ready(function () {
    ...
    var table = $('#dynamic-table').DataTable( {
        ajax: {
            url: "/dashboard/get/json/index/materials/scrap",
            dataSrc: 'data'
        },
        bAutoWidth: false,
        "aoColumns": [
            ...
            { data: null,
                ...
                "render": function (item)
                {
                    if ( item.type_scrap.length == null )
                    {
                        return 'No tiene';
                    } else {
                        return item.type_scrap.length;
                    }
            ...
            { data: null,
                ...
                "render": function (item)
                {
                    if ( item.type_scrap.width == null )
                    {
                        return 'No tiene';
                    } else {
                        return item.type_scrap.width;
                    }
                }
            },
            { data: null,
                ...
                {
                    var text = '';
                    text = text + '<a href="'+document.location.origin+ '/dashboard/ver/items/material/'+item.id+'" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Ver items"><i class="fa fa-box-open"></i> </a>  ';
                    return text;
                }
            },
