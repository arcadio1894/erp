    ...
    $('#dynamic-table').DataTable( {
        ...
        "aoColumns": [
            ...
            { data: null,
                ...
                {
                    var text = '';
                    if ( $.inArray('update_materialType', $permissions) !== -1 ) {
                        text = text + '<a href="'+document.location.origin+ '/dashboard/editar/tipomaterial/'+item.id+
                            '" class="btn btn-outline-warning btn-sm"><i class="fa fa-pen"></i></a>';
                    }
                    if ( $.inArray('destroy_materialType', $permissions) !== -1 ) {
        ...
        $.confirm({
            ...
            buttons: {
                confirmar: {
                    ...
                    action: function () {
                        $.ajax({
                            url: '/dashboard/materialtype/delete-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
