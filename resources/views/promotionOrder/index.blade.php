...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('promotionOrder.index') }}"><i class="fa fa-archive"></i> Orden de Promociones</a>
        </li>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex align-items-center">
                    <span data-order class="mr-2"></span>
                    <div class="btn-group btn-group-sm" role="group">
                        <button class="btn btn-light btn-up" data-direction="up" data-toggle="tooltip" title="Subir">
                            ▲
                        </button>
                        <button class="btn btn-light btn-down" data-direction="down" data-toggle="tooltip" title="Bajar">
                            ▼
                        </button>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/promotionOrder/index.js') }}?v={{ time() }}"></script>
