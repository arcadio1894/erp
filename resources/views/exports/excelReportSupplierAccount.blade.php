...
<table id="table">
    ...
    <thead>
        ...
        <tr>
            ...
            <th width="300px" style="background-color:#074f91; color: #ffffff; text-align: center">Email</th>
            <th width="150px" style="background-color:#074f91; color: #ffffff; text-align: center">Cuentas</th>
        </tr>
    </thead>
