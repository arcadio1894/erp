...
@section('activeReportInvoiceSinOrden')
    active
@endsection

@section('title')
    Facturas de Finanzas Sin Orden
@endsection
...
@section('page-header')
    <h1 class="page-title">Facturas de Finanzas Sin Orden</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Listado de facturas Sin Orden</h5>
    @can('create_invoice')
...
@section('scripts')
    ...
    <script src="{{ asset('js/invoice/report_invoice_sin_orden.js') }}"></script>
    {{--<script>
