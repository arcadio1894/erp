...
@section('content')
    ...
    <form id="formCreate" class="form-horizontal" data-url="{{ route('promotionLimit.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control material_search" data-material style="width:100%" name="material_search"></select>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <input type="number" id="cantidadLimite" class="form-control" placeholder="0.00" min="0" value="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="applies_to" id="porTrabajador" value="worker" checked>
                                    <label class="form-check-label" for="porTrabajador">
                                        Por Trabajador
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="applies_to" id="global" value="global">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="price_type" id="fijado" value="fixed" checked>
                                    <label class="form-check-label" for="fijado">
                                        Fijado
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="price_type" id="porcentaje" value="percentage">
                                    <label class="form-check-label" for="porcentaje">
                                        Porcentaje
                                    </label>
                                </div>
                                <br>
                                <input type="number" id="tipoPrecio" class="form-control" placeholder="0.00" min="0" value="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                    this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red'
                                    ">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <input type="number" id="precioOriginal" class="form-control" placeholder="0.00" min="0" value="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                    this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red'
                                    ">
                            </div>
                            <div class="col-md-4">
                                <label for="material_search">Precio promoción </label>
                                <input type="number" id="precioPromocion" class="form-control" placeholder="0.00" min="0" value="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                    this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red'
                                    ">
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/promotionLimit/create.js') }}?v={{ time() }}"></script>
@endsection
