...
@section('activeCreateRelationships')
    active
@endsection
...
@section('page-header')
    <h1 class="page-title">Parentescos</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Crear Parentesco</h5>
...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('relationship.store') }}" enctype="multipart/form-data">
        @csrf
...
@section('scripts')
    <script src="{{ asset('js/relationship/create.js') }}"></script>
@endsection
