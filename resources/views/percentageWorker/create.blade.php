...
@section('activeCreatePercentageWorker')
    active
@endsection
...
@section('page-header')
    <h1 class="page-title">Porcentaje de recursos humanos</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Crear nuevo porcentaje</h5>
    <a href="{{ route('percentageWorker.index') }}" class="btn btn-outline-success btn-sm float-right" > <i class="fa fa-arrow-left font-20"></i> Listado de Porcentajes </a>
@endsection
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('percentageWorker.index') }}"><i class="fa fa-archive"></i> Porcentaje de recursos humanos</a>
        </li>
...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('percentageWorker.store') }}" enctype="multipart/form-data">
        @csrf
...
@section('scripts')
    <script src="{{ asset('js/percentageWorker/create.js') }}"></script>
@endsection
