...
@section('page-header')
    <h1 class="page-title">Generar Reporte de Bonos especiales</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Reporte de Bonos especiales</h5>
    <a href="{{ route('bonusRisk.index') }}" class="btn btn-outline-primary btn-sm float-right" > <i class="fa fa-arrow-left font-20"></i> Listado de Bonos especiales</a>&nbsp;
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-plus-circle"></i> Reporte de Bonos especiales</li>
    </ol>
@endsection
    ...
    <div id="report-expense" style="display: none">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h3 class="card-title">Reporte de Bonos especiales</h3>
...
@section('scripts')
    ...
    <script src="{{ asset('js/bonus/report.js') }}"></script>
@endsection
