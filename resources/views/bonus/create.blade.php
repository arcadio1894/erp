...
@section('page-header')
    <h1 class="page-title">Nuevo Bono Especial</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Crear nuevo bono especial</h5>
...
@section('content')
    ...
    <form id="formCreate" class="form-horizontal" data-url="{{ route('bonusRisk.store') }}" enctype="multipart/form-data">
        @csrf
...
@section('scripts')
    ...
    <script src="{{ asset('js/bonus/create.js') }}"></script>
@endsection
