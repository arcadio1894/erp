...
@section('activeFollow')
    active
@endsection

@section('activeListFollow')
    active
@endsection
...
@section('page-title')
    <h5 class="card-title">Listado de materiales en seguimiento </h5>
    {{--@can('create_quote')
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('follow.index') }}"><i class="fa fa-archive"></i> Materiales en seguimiento</a>
        </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Importante!</strong> Aquí se mostrarán el estado de los materiales en seguimiento.
