    ...
    <form id="formEdit" class="form-horizontal" data-url="{{ route('brand.update') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" onkeyup="mayus(this);" name="name" placeholder="Ejm: Marca" value="{{$brand->name}}">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" onkeyup="mayus(this);" name="comment" placeholder="Ejm: Descripción" value="{{$brand->comment}}">
                </div>
            </div>
        </div>
