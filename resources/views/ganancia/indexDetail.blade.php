...
@section('page-header')
    <div class="row">
        ...
        <h1 class="page-title">Detalle de Ganancias Diarias</h1>
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-plus-circle"></i> Detalles</li>
    </ol>
@endsection

@section('content')
    <input type="hidden" id="permissions" value="{{ json_encode($permissions) }}">
    <input type="hidden" id="ganancia" value="{{ json_encode($ganancia) }}">
    <!--begin::Toolbar-->
    <div class="d-flex flex-wrap flex-stack pb-7">
        <!--begin::Title-->
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bolder me-5 my-1"><span id="numberItems"></span> Detalle de Ganancias
...
@section('scripts')
    <script src="{{ asset('js/ganancias/indexDetail.js') }}"></script>
@endsection
