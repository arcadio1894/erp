...
@section('page-header')
    <h1 class="page-title">Feriado: {{ $holiday->code }}</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Modificar Feriado</h5>
...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('holiday.update') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="date_complete" name="date_complete" class="form-control" value="{{ ($holiday->date_complete == null) ? '': $holiday->date_complete->format('d/m/Y') }}" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                </div>
            </div>
            <div class="col-md-2">
                ...
                <div class="input-group">
                    ...
                    <input id="year" type="text" class="form-control" name="year" value="{{ $holiday->year }}">
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/holiday/edit.js') }}"></script>
@endsection
