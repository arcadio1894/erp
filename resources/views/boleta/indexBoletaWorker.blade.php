...
@section('page-header')
    <h1 class="page-title">{{ $worker->last_name. ' ' . $worker->first_name }}</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Listado de los boletas</h5>
    <a href="{{ route('paySlip.index', $worker->id) }}" class="btn btn-outline-primary btn-sm float-right" > <i class="fa fa-arrow-left font-20"></i> Listado de trabajadores</a>&nbsp;
...
@section('scripts')
    <script src="{{ asset('js/boleta/indexBoletaWorker.js') }}"></script>
@endsection