...
@section('activeListCivilStatusDeleted')
    active
@endsection
...
@section('page-title')
    <h5 class="card-title">Listado de estados civiles eliminados</h5>
    ...
    <div id="modalDelete" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formDelete" data-url="{{ route('civilStatuses.restore') }}">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" id="civilStatus_id" name="civilStatus_id">
                        <p> ¿Desea habilitar este estado civil? </p>
                        <p id="description"></p>
                    </div>
...
@section('scripts')
    <script src="{{ asset('js/civilStatus/indexDeleted.js') }}"></script>
@endsection