...
@section('openEntryPurchaseReport')
    menu-open
@endsection

@section('activeEntryPurchaseReport')
    active
@endsection

@section('activeListEntryPurchaseReport')
    active
@endsection
...
@section('page-header')
    <h1 class="page-title">Reporte de Entradas por compras</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Reporte de entradas</h5>
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-archive"></i> Reporte de Entradas por compras </li>
    </ol>
@endsection
...
@section('content')
    ...
    @can('searchReportEntries_entryPurchase')
        <form id="myForm">
            @csrf
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    <button type="button" id="submitButton" class="btn btn-primary me-5">Buscar</button>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/entry/index_entry_purchase_report.js') }}"></script>
