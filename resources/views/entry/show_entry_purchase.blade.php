...
@section('page-title')
    <h5 class="card-title">Visualizar entrada por compra</h5>
@endsection
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-plus-circle"></i> Visualizar entrada</li>
    </ol>
@endsection
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="referral_guide" name="referral_guide" class="form-control" value="{{ $entry->referral_guide }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="purchase_order">Orden de Compra</label>
                                    <input type="text" id="purchase_order" name="purchase_order" class="form-control" value="{{ $entry->purchase_order }}" readonly="">
                                </div>
                                <div class="form-group">
                                    <label for="supplier">Proveedor </label>
                                    <select id="supplier" disabled name="supplier_id" class="form-control select2" style="width: 100%;">
                                        <option></option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="btn-grouped" readonly type="checkbox" name="deferred_invoice" {{ ($entry->deferred_invoice==='on') ? 'checked':'' }} data-bootstrap-switch data-off-color="danger" data-on-text="SI" data-off-text="NO" data-on-color="success">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="observation" readonly cols="30" class="form-control" style="word-break: break-all;" placeholder="Ingrese observación ....">{{ $entry->observation }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
