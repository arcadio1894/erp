                ...
                <form id="formCreate" class="form-horizontal" data-url="{{ route('container.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" id="name" onkeyup="mayus(this);" name="name" class="form-control" placeholder="Ejm: Único" required />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" id="comment" onkeyup="mayus(this);" name="comment" class="form-control" placeholder="Ejm: Contenedor único" />
                            </div>
                        </div>
                    </div>
