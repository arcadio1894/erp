...
@section('page-title')
    <input type="hidden" name="worker_id" id="worker_id" value="{{ $supplier->id }}">
    <h5 class="card-title">Listado de los cuentas bancarias de {{ $supplier->business_name }}</h5>
@endsection
            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @can('create_supplierAccount')
                        <button type="button" id="newAccount" data-url="{{ route('supplier.account.store', $supplier->id) }}" class="btn btn-sm btn-warning" > <i class="far fa-credit-card"></i> Agregar Cuenta </button>
                        @endcan
...
@section('scripts')
    ...
    <script src="{{ asset('js/supplierAccount/create.js') }}"></script>
@endsection