...
@section('activeReportTotalBruto')
    active
@endsection
...
@section('page-header')
    <h1 class="page-title">Reporte de Total Bruto</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Total Bruto</h5>
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-plus-circle"></i> Total Bruto</li>
    </ol>
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('js/assistance/totalBruto.js') }}"></script>
@endsection
