...
@section('page-title')
    ...
    <a href="{{ route('vacation.create') }}" class="btn btn-outline-success btn-sm float-right" > <i class="fa fa-plus font-20"></i> Nuevas vacaciones </a>
    ...
    <div id="modalDelete" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formDelete" data-url="{{ route('vacation.destroy') }}">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" id="vacation_id" name="vacation_id">
                        <strong> ¿Desea eliminar estas vacaciones? </strong>
                        <p> Deberá verificar las asistencias en las fechas de las vacaciones </p>
                        <p id="code"></p>
                    </div>
...
@section('scripts')
    <script src="{{ asset('js/vacation/index.js') }}"></script>
@endsection