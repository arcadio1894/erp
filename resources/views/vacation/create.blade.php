...
@section('page-header')
    <h1 class="page-title">Nuevas Vacaciones</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Crear nuevas vacaciones</h5>
    <a href="{{ route('vacation.index') }}" class="btn btn-outline-primary btn-sm float-right" > <i class="fa fa-arrow-left font-20"></i> Listado de Vacaciones</a>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Importante!</strong> Al crear vacaciones se modificarán las asistencias de los días colocados.
                <br>
    ...
    <form id="formCreate" class="form-horizontal" data-url="{{ route('vacation.store') }}" enctype="multipart/form-data">
        @csrf
