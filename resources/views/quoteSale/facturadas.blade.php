...
@section('activeListFacturadasQuote')
    active
@endsection
...
@section('page-header')
    <h1 class="page-title">Listado de Cotizaciones Facturadas</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Listado de cotizaciones facturadas</h5>
...
@section('scripts')
    ...
    <script src="{{ asset('js/quoteSale/facturadas.js') }}"></script>
