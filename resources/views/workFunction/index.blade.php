...
@section('page-title')
    <h5 class="card-title">Listado de cargos habilitados</h5>
    ...
    <div id="modalDelete" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formDelete" data-url="{{ route('workFunctions.destroy') }}">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" id="workFunction_id" name="workFunction_id">
                        <p> ¿Desea inhabilitar este cargo? </p>
                        <p id="description"></p>
                    </div>
...
@section('scripts')
    <script src="{{ asset('js/workFunction/index.js') }}"></script>
@endsection