...
@section('activeCreatePensionSystem')
    active
@endsection
...
@section('page-header')
    <h1 class="page-title">Sistemas de pensiones</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Crear sistema de pensión</h5>
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('pensionSystems.index') }}"><i class="fa fa-archive"></i> Sistema de pensión</a>
        </li>
...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('pensionSystems.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input id="percentage" type="number" min="0" step="0.01" class="form-control" name="percentage" >
...
@section('scripts')
    <script src="{{ asset('js/pensionSystem/create.js') }}"></script>
@endsection
