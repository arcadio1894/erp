...
@section('activeListPensionSystemDeleted')
    active
@endsection
...
@section('page-title')
    <h5 class="card-title">Listado de sistemas de pensión eliminados</h5>
    ...
    <div id="modalDelete" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formDelete" data-url="{{ route('pensionSystems.restore') }}">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" id="pensionSystem_id" name="pensionSystem_id">
                        <p> ¿Desea habilitar este sistema de pensión? </p>
                        <p id="description"></p>
                    </div>
...
@section('scripts')
    <script src="{{ asset('js/pensionSystem/indexDeleted.js') }}"></script>
@endsection